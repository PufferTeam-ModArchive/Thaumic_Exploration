...
//
//
// private static final ResourceLocation largeJarTexture = new
// ResourceLocation("thaumicexploration:textures/blocks/replicatorRunes.png");
// @Override
...
// GL11.glTranslatef(1.0F, MathHelper.sin((float)
// (Math.toRadians(ticks*10.0F+tickOffset*1000.0F+(360.0F/highestFilledSlot)*i)))/5.0F, 0.0F);
