...
public class ConfigTX {
    ...
    public static void loadConfig(FMLPreInitializationEvent event) {
        ...
        allowThaumcraftCrucibleRefill = config
                .get("EverfullUrn", "Allow the Everfull Urn to fill up Thaumcraft Crucibles", true).getBoolean(true);
        ...
        allowVanillaCauldronRefill = config
                .get("EverfullUrn", "Allow the Everfull Urn to fill up vanilla Cauldrons", true).getBoolean(true);
        ...
        allowWitcheryCauldronRefill = config
                .get("EverfullUrn", "Allow the Everfull Urn to fill up Witchery Cauldrons", true).getBoolean(true);
        allowWitcheryKettleRefill = config
                .get("EverfullUrn", "Allow the Everfull Urn to fill up Witchery Kettles", true).getBoolean(true);
